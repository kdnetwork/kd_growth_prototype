...
return array(
	'plugin' => array(
		'name'        => '成长任务',            //插件名称，必填
		'version'     => '0.2',                 //插件版本号
		'description' => '完成贴吧用户成长任务',  //插件描述
		'onsale'      =>  false,                 //bool 插件是否已在产品中心上架
		'url'         => 'https://github.com/kdnetwork/kd_growth_prototype',  //插件地址，比如哪里可以下载到这个插件
		'for'         => 'V5.00+',                 //适用的云签到版本，all为所有版本，版本后面跟+表示适用于该版本或更高版本，如V4.0+
		'forphp'      => '8.2'                  //适用的PHP版本，如果定义了，系统就在安装和激活时进行版本对比，如果版本低于forphp，自动禁止下一步操作，all为所有版本
	),
	'author' => array(
		'author'      => 'Anonymous',      //作者名称
		'email'       => 'a@a.a',   //作者邮箱
		'url'         => 'https://github.com/kdnetwork/kd_growth_prototype'   //作者的个人网站
	),
	'view'   => array(
